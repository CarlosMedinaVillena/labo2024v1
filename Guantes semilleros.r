...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  #DT_incorporar_dataset_default( "DT0001_final1", "competencia_2024.csv.gz")
  #CA_catastrophe_default( "CA0001_final1", "DT0001_final1" )
  
#  DR_drifting_guantesblancos( "DR0001_final1", "CA0001_final1" )
 # FE_historia_guantesblancos( "FE0001_final1", "DR0001_final1" )
  
#  TS_strategy_guantesblancos_202109( "TS0001_final1", "FE0001_final1" )
  
#  HT_tuning_guantesblancos( "HT0001_final1", "TS0001_final1" )
  
  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0001-sem", c("HT0001_final1","TS0001_final1") )
...
corrida_guantesblancos_202109( "gb01_semillerio" )
