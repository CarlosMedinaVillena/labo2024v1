...
TS_strategy_01_a <- function( pmyexp, pinputexps, pserver="local")
{
  if( -1 == (param_local <- exp_init( pmyexp, pinputexps, pserver ))$resultado ) return( 0 )# linea fija
...
#------------------------------------------------------------------------------
TS_strategy_01_b <- function( pmyexp, pinputexps, pserver="local")
{
  if( -1 == (param_local <- exp_init( pmyexp, pinputexps, pserver ))$resultado ) return( 0 )# linea fija
  ...
  param_local$final_train <- c(2202105,202104,202103,202102,202101,202012,202011,202010,202009)
...
TS_strategy_02_a <- function( pmyexp, pinputexps, pserver="local")
{
  if( -1 == (param_local <- exp_init( pmyexp, pinputexps, pserver ))$resultado ) return( 0 )# linea fija
...
#------------------------------------------------------------------------------
TS_strategy_02_b <- function( pmyexp, pinputexps, pserver="local")
{
  if( -1 == (param_local <- exp_init( pmyexp, pinputexps, pserver ))$resultado ) return( 0 )# linea fija
...
TS_strategy_03_a <- function( pmyexp, pinputexps, pserver="local")
{
  if( -1 == (param_local <- exp_init( pmyexp, pinputexps, pserver ))$resultado ) return( 0 )# linea fija
...
#------------------------------------------------------------------------------
TS_strategy_03_b <- function( pmyexp, pinputexps, pserver="local")
{
  if( -1 == (param_local <- exp_init( pmyexp, pinputexps, pserver ))$resultado ) return( 0 )# linea fija
...
TS_strategy_04_a <- function( pmyexp, pinputexps, pserver="local")
{
  if( -1 == (param_local <- exp_init( pmyexp, pinputexps, pserver ))$resultado ) return( 0 )# linea fija
...
#------------------------------------------------------------------------------
TS_strategy_04_b <- function( pmyexp, pinputexps, pserver="local")
{
  if( -1 == (param_local <- exp_init( pmyexp, pinputexps, pserver ))$resultado ) return( 0 )# linea fija
...
TS_strategy_05_a <- function( pmyexp, pinputexps, pserver="local")
{
  if( -1 == (param_local <- exp_init( pmyexp, pinputexps, pserver ))$resultado ) return( 0 )# linea fija
...
#------------------------------------------------------------------------------
TS_strategy_05_b <- function( pmyexp, pinputexps, pserver="local")
{
  if( -1 == (param_local <- exp_init( pmyexp, pinputexps, pserver ))$resultado ) return( 0 )# linea fija
...
TS_strategy_06_a <- function( pmyexp, pinputexps, pserver="local")
{
  if( -1 == (param_local <- exp_init( pmyexp, pinputexps, pserver ))$resultado ) return( 0 )# linea fija
...
#------------------------------------------------------------------------------
TS_strategy_06_b <- function( pmyexp, pinputexps, pserver="local")
{
  if( -1 == (param_local <- exp_init( pmyexp, pinputexps, pserver ))$resultado ) return( 0 )# linea fija
...
corrida_problema20_grupoA <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija

  DT_incorporar_dataset_default( "DT2001", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA2001", "DT2001" )

  DR_drifting_guantesblancos( "DR2001", "CA2001" )
  FE_historia_guantesblancos( "FE2001", "DR2001" )

  # 01
  TS_strategy_01( "TS2001", "FE2001" )
  HT_tuning_guantesblancos( "HT2001", "TS2001" )
  ZZ_final_guantesblancos( "ZZ2001", c("HT2001","TS2001") )

  # 02
  TS_strategy_02( "TS2002", "FE2001" )
  HT_tuning_guantesblancos( "HT2002", "TS2002" )
  ZZ_final_guantesblancos( "ZZ2002", c("HT2002","TS2002") )

  # 03
  TS_strategy_03( "TS2003", "FE2001" )
  HT_tuning_guantesblancos( "HT2003", "TS2003" )
  ZZ_final_guantesblancos( "ZZ2003", c("HT2003","TS2003") )

  # 04
  TS_strategy_04( "TS2004", "FE2001" )
  HT_tuning_guantesblancos( "HT2004", "TS2004" )
  ZZ_final_guantesblancos( "ZZ2004", c("HT2004","TS2004") )

  # 05
  TS_strategy_05( "TS2005", "FE2001" )
  HT_tuning_guantesblancos( "HT2005", "TS2005" )
  ZZ_final_guantesblancos( "ZZ2005", c("HT2005","TS2005") )

  # 06
  TS_strategy_06( "TS2006", "FE2001" )
  HT_tuning_guantesblancos( "HT2006", "TS2006" )
  ZZ_final_guantesblancos( "ZZ2006", c("HT2006","TS2006") )

  exp_wf_end( pnombrewf, pvirgen ) # linea fija
}
#------------------------------------------------------------------------------

corrida_problema20_grupoA( "p20gA" )
